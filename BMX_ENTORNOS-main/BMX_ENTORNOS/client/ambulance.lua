...
AddEventHandler('enp-ambulance:auxilio:sendNotify', function( msg, location, pos )
  if job == 'ambulance' then 
    ...
    TriggerEvent('pNotify:SendNotification',{text = "Auxilio  </br> "..msg.."  en  "..location.." </br>  Distancia: "..dist.." Km </br> <p> </p><b style='color:#3efe00'>[E Aceptar] </b> <b style='color:#fe0000'>[Q Denegar] </b>", 
    timeout = 15000,
      type = "error",
      progressBar = true,
      layout     = "centerRight",
