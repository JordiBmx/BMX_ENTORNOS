...
AddEventHandler('enp-mechanic:sendNotify', function( msg, location, pos, IdPlayer )
  if job == 'mechanic' then 
    ...
    TriggerEvent('pNotify:SendNotification',{text = "LLAMADA MECANICO  </br> "..msg.."  en  "..location.." </br>  Distancia: "..dist.." Km </br> <p> </p><b style='color:#3efe00'>[E Aceptar] </b> <b style='color:#fe0000'>[Q Denegar] </b>", 
    timeout = 15000,
      type = "success",
      progressBar = true,
      layout     = "centerRight",
